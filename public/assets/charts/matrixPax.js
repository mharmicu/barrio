    ...
    while (dt <= end) {
        ...
        if (x_pax.indexOf(iso) !== -1) {
            ...
            data2.push({
                ...
                y: isoDayOfWeek(dt),
                d: iso,
                v: y_pax[x_pax.findIndex(indexNum)]
            });
        } else {
            data2.push({
                x: iso,
...
// render init block
const matrixPax = new Chart(
    document.getElementById('matrixChartPax'),
    configPax
);