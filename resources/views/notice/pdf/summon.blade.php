...
<body style=" font-family: 'Times New Roman', serif !important;">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <p class="lh-lg">This <b>{{date('jS', strtotime($notice->date_notified))}}</b> day of <b>{{date('F', strtotime($notice->date_notified))}}, {{date('Y', strtotime($notice->date_notified))}}.</b>.</p>
