            ...
            <div class="container-fluid">
                ...
                <div class="row d-flex justify-content-center  p-5">
                    <div class="card p-3 shadow">
                        ...
                        <p class="fst-italic text-primary">Case Number. Case Title</p>

                        <p class="fw-normal"><b>Latest Hearing: MEDIATION (ex) on October 6, 2022, 12:00nn</b></p><br>
                        ...
                        <div class="mb-3 mt-3">
                            <button type="submit" class="btn btn-danger">File Court Action</button>
                        </div>
                    </div>
                </div>
            </div>
